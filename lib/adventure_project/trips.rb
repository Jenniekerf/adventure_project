class AdventureProject::Trips
 ...
 def self.all
  ...
  def self.scraped_trips
    trips = []
    trips << self.scraped_trip_1
    trips << self.scraped_trip_2
    trips << self.scraped_trip_3
    trips << self.scraped_trip_4
    trips << self.scraped_trip_5
    trips << self.scraped_trip_6
    trips << self.scraped_trip_7
    trips << self.scraped_trip_8
    trips << self.scraped_trip_9
    trips << self.scraped_trip_10
    trips << self.scraped_trip_11
    #binding.pry 
    trips
  end
